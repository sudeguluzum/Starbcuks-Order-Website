...
<body>
      ...
      <header>
         ...
         <ul class="navbar">
            ...
            <li> <a href="login.html" class="buton">Login</a></li>
            <li> <a href="login.html" class="buton2">Join Now</a></li>
         </ul>
      </header>
      ...
      <main class="c-main-container">
        <section class="home" id="home">
            <div class="home-text">
               ...
               <a href="login.html" class="buton">Order Now</a>
            </div>
            <div class="home-img">
